...
chat_promt_template = ChatPromptTemplate.from_messages([
    ("system", "You are a Summarizer expert AI assistant in Bangla language. Always summarize the text in Bangla."),
    ("human", 
     """I will give you a bangla text. The text is a transcription of an call center bangla audio conversation. 
     I want you to summarize the bangla text for me.
    Here is the bangla text: 
